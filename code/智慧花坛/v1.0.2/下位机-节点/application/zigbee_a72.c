...
//	rt_kprintf("\n");//Debug
	...
	if(rx_data_buf[0] == _COORDINATOR)
	{
		if(rx_data_buf[1] == Zigbee_check)//
		{
			rt_kprintf("\nZigbee_check\n\n");
			A72_u8 send_buf[2] = {_NODE1,Zigbee_check};
			A72_SEND_DATA(_COORDINATOR,&A72_SEND_MODE_IEEE,send_buf,2);//回应心跳包
		}
	}
