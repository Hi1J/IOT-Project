...
extern u8 SD_GetResponse(u8 Response);					//获得相应
extern u8 SD_Initialize(void);							         //初始化
extern u8 SD_ReadDisk(u8*buf,u32 sector,u16 cnt);		  //读块
extern u8 SD_WriteDisk(u8*buf,u32 sector,u16 cnt);		//写块
